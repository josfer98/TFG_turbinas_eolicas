 ...
 contador1 = 1;
     ...
     figure
         for THETA_1_SETUP = 0:0.4:3.2
            ...
            [potencia_0, potencia_1] = potencia_y_eficiencia(omega, torque_global_0, torque_global_1);
...
%% velocidad_angular
    ...
    function [potencia_0, potencia_1] = potencia_y_eficiencia(omega, torque_global_0, torque_global_1)
...
%Potencia obtenida dependiendo de la velocidad del viento
    ...
    title('Potencia obtenida en base a la velocidad del viento y el tamaño de la pala');
