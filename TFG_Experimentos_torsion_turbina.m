...
%     contador0 = 0.01;
%     contador1 = 0.01;
%  figure('Name','Ángulo cabeceo = 2° y ángulo torsión = 0.01-0.04°')
...
% PRUEBA 3
    ...
    contador0 = 50;
    contador1 = 50;
 figure('Name','Ángulo cabeceo = 2° y ángulo torsión = 50-58°')
    for DELTA_THETA_SETUP = 50:1:58
        THETA_1 = 2;
        theta_CL = THETA_1;
        ...
        [contador0, contador1] = plot_torsion(U_VIENTO, potencia_0, potencia_1, contador0, contador1);
        title('Pot en base a U VIENTO, Ángulo cabeceo = 2° y ángulo torsión = 50-58° creciente');
...
%             for j = 1:N
%                 if j < 2
%                     theta_i(1) = THETA_1 + (N * DELTA_THETA);
%                 else
%                     theta_i(j) = theta_i(j-1) - DELTA_THETA;
%                 end
%             end
...
%Potencia obtenida dependiendo de la velocidad del viento
    ...
    leyenda1 = ['Potencia CON torsión ', num2str(contador1),'°']; contador1 = contador0 + contador1;
    leyenda0 = ['Potencia SIN torsión '];
    
    % Para que solo haga plot 1 vez de la potencia sin torsión
    if contador1 == contador0 * 2;
