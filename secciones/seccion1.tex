...
%METEMOS AQUÍ LA FIGURA DEL ARTÍCULO 
\iffalse
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/segmento pala articulo carlos.png}
    \caption{Representación esquemática de un segmento de una pala de una turbina eólica}
    \textit{Fuente: \cite{armenta2021predictive}}
    \label{fig:pala_simp}
\end{figure}
\fi


%Esto probablemente haya que justificar como se hicieron los cálculos.
...
%ESTA FÓRMULA TAMBIÉN ESTÁ MAL, EL BRAZO VA AL CENTRO GEOMETRÍCO
\begin{definicion}
...
%No sé si es correcta, quizás la tangente del ángulo debería ser diferente, para que al final de la misma desviación. 
 \begin{definicion}
...
%EL FORMATO ANDA UN POCO MAL, TENGO QUE MEJORARLO
...
\subsubsection{EXPLICACIÓN DE LA VELOCIDAD ANGULAR}
 ...
 %Para entender este apartado, página 174 del libro de Alonso Finn
